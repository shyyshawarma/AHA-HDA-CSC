...
class UIR_PolyKernel(nn.Module):
    ...
    def forward(self, x):
        ...
        aha1_output = self.attention_lka1_to_lka2(inp_enc_level2)
        inp_enc_level3 = self.down2_3(aha1_output)
        # out_enc_level3 = self.encoder_level3(inp_enc_level3)
        aha2_output = self.attention_lka2_to_csc(inp_enc_level3)
        ...
        first_decode = cat(latent, aha2_output)
        ...
        inp_dec_level2 = self.up3_2(aha_input)
        aha2_input = cat(inp_dec_level2, aha1_output)
        ...
        inp_dec_level1 = self.up2_1(aha2_input)
